...
def jtshoot():
    ...
    ssly=input(f'{bcolors.OKBLUE}Press{bcolors.ENDC} {bcolors.WARNING}"s"{bcolors.ENDC}{bcolors.OKBLUE} for Https and {bcolors.ENDC}{bcolors.WARNING}"p"{bcolors.ENDC}{bcolors.OKBLUE}for Http{bcolors.ENDC}')
    if ssly=='s':
        httpy='https://'+domain
    elif ssly=='p':
        httpy='http://'+domain
    ...
    print(f"{bcolors.HEADER}Press '0' for Ping\nPress '1' for Traceroute\nPress '2' for Dig\nPress '3' for Whois\nPress '4' for Nslookup\nPress '5' for TTFB\nPress '6' for Response Headers\n\nWhat do you want to do? {bcolors.ENDC}")
    job=list(str(input(" ")))
    def jping():
